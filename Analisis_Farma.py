...
def EXTRAER_MES(df,columna_fecha,columna_precio):
    """
...
def not_in_portafolio(df_portafolio, df_total_rotation_data,columna_codigo_barras,nombre_producto):
...
def report_regional_months(df,header_region, header_month,header_number_month,cost):
...
Inventario_data1 = same_shape_inventario(Inventario_data1)
Inventario_data2 = same_shape_inventario(Inventario_data2)
Inventario_data3 = same_shape_inventario(Inventario_data3)
Inventario_data4 = same_shape_inventario(Inventario_data4)
Inventario_data5 = same_shape_inventario(Inventario_data5)
Inventario_data6 = same_shape_inventario(Inventario_data6)
Inventario_data7 = same_shape_inventario(Inventario_data7)
Inventario_data8 = same_shape_inventario(Inventario_data8)
Inventario_data9 = same_shape_inventario(Inventario_data9)
Inventario_data10 = same_shape_inventario(Inventario_data10)
Inventario_data11 = same_shape_inventario(Inventario_data11)
Inventario_data12 = same_shape_inventario(Inventario_data12)
...
Uniform_Names_Inventario = uniform_regions(Inventario_data,'Regional')

##################################### REPORTE Y ORDEN POR MES EN INVENTARIO 
month_inform_inventario, general_df_inventrio = EXTRAER_MES(Uniform_Names_Inventario,'FECHA','COSTO TOTAL ARTICULO')
...
#-----------------------------------------------------------------------------------------------------------------------
#-----------------------------------------------------------------------------------------------------------------------
Uniform_Names = uniform_regions(rotation_data,'Regional')

######## ORDENAR POR MES 
month_inform, general_df_rotation = EXTRAER_MES(Uniform_Names,'Periodo','Costo Compra')
...
df_report_months_rotation = report_regional_months(general_df_rotation,'Regional Correcta','Mes','Mes Numerico', 'Costo Compra')
